    ...
    return (
        <div className='flex flex-col lg:flex-row justify-evenly items-center gap-6  text-center min-h-[100vh] px-6 md:px-10 py-10 lg:py-0'>
            ...
            <div>
                ...
                <p className="py-4 text-lg lg:w-[80%] mx-auto">Stay informed with live updates, track your pickup status, get notifications, and enjoy a seamless, worry-free experience</p>
            </div>
            </div>
            ...
            <div>
                ...
                <p className="py-4 text-lg lg:w-[80%] mx-auto">Discover eco-friendly products crafted from recycled waste. Support a greener future by shopping items that promote sustainability.</p>
            </div>
            </div>
        </div>
    );
