    ...
    >
      <SwiperSlide>
        <div className="relative">
          ...
          <div className="md:relative md:top-[-80px] md:w-82 bg-white p-6 shadow-xl lg:rounded-lg">
            ...
            <p className="py-4">
              ...
              making it easier for households to contribute to a greener future.
            </p>
        ...
        <div className="relative">
          ...
          <div className="md:relative md:top-[-80px] md:w-82 bg-white p-6 shadow-xl lg:rounded-lg">
            ...
            <p className="py-4">
              ...
              EcoBin offers flexible collection schedules, responsible disposal,
              and customized recycling programs to support your company's
        ...
        <div className="relative">
          ...
          <div className="md:relative md:top-[-80px] md:w-82 bg-white p-6 shadow-xl lg:rounded-lg">
            ...
            <p className="py-4">
              ...
              disposal of industrial by-products, ensuring full compliance with
              environmental regulations while minimizing your facility's
        ...
        <div className="relative">
          ...
          <div className="md:relative md:top-[-80px] md:w-82 bg-white p-6 shadow-xl lg:rounded-lg">
            ...
            <p className="py-4">
              ...
              pharmacies, our services protect public health and the environment
              by adhering to strict industry safety standards.
            </p>
            <div className="text-black text-lg hover:text-white flex items-center gap-4">
              <Link>
                <button className="btn bg-white border-black hover:border-0 hover:text-white shadow-xl p-4 hover:bg-[#059212] ">
        ...
        <div className="relative">
          ...
          <div className="md:relative md:top-[-80px] md:w-82 bg-white p-6 shadow-xl lg:rounded-lg">
            ...
            <p className="py-4">
              ...
              construction and demolition debris. We help reduce landfill impact
              and promote the responsible reuse of materials wherever possible.
            </p>
            <div className="text-black text-lg hover:text-white flex items-center gap-4">
              <Link>
                <button className="btn bg-white border-black hover:border-0 hover:text-white shadow-xl p-4 hover:bg-[#059212] ">
      ...
      <SwiperSlide>
        <div className="relative">
          ...
          <div className="md:relative md:top-[-80px] md:w-82 bg-white p-6 shadow-xl lg:rounded-lg">
            <h2 className="text-3xl font-bold pt-6">Landfilling Solutions</h2>
            <p className="py-4">
