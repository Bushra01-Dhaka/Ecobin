...
const RequestService1 = () => {
  ...
  const [serviceType, setServiceType] = useState("Regular"); // default Regular
  ...
  const containerPrices = {
    ...
    "3 Trucks Demolition/Garbage Waste": 15000,
  ...
  const handleServiceChange = (event) => {
    ...
    setTruckNo(0);
    setProductType("");
    setPrice(containerPrices["No Required"]);
    setServiceType("Regular"); // reset default

    // auto-set Regular for Mutual Benefit Program
    if (value === "Mutual Benefit Program") {
  ...
  const handleServiceRequest = (event) => {
    ...
    const container_size = form.container_size?.value || "N/A";
    ...
    if (
      service === "Land Filling Service" ||
      service === "Construction & Demolition Waste" ||
      service === "Mutual Benefit Program"
    ) {
      requestInfo.truck_no = truckNo;
      requestInfo.product_type = productType;
      requestInfo.service_type = serviceType;
    }
        ...
        <div className="flex-1 p-6 text-slate-800">
          ...
          <div>
            ...
            >
              ...
              {/* Truck + Product Type + Service Type fields only for specific services */}
              {selectedService === "Land Filling Service" ||
              selectedService === "Construction & Demolition Waste" ||
              selectedService === "Mutual Benefit Program" ? (
                <>
                  <div className="mb-10">
                    <label className="font-bold">Number of Trucks*</label>
                    <input
                      type="number"
